...
export default function BodyDoubling() {
  ...
  return <SupportToolThemeProvider theme="adhd_focus"><SupportToolLayout className="!m-0 !w-full !max-w-none !gap-0 !p-0"><main className="relative w-full min-w-0 bg-[#fffefa] px-4 py-4 text-[#202036] sm:px-8 sm:py-5 lg:px-[9vw]">
    <header className="relative mx-auto flex max-w-6xl items-start justify-between gap-5"><div className="min-w-0"><p className="inline-flex items-center gap-2 rounded-full bg-[#dff8d6] px-3 py-1.5 text-[10px] font-black uppercase tracking-[.16em] text-[#24743a]"><Target size={15} /> ONE TASK. ONE VISIBLE TIMER.</p><h1 className="mt-3 flex flex-wrap items-center gap-2 text-3xl font-black tracking-tight sm:gap-3 sm:text-4xl md:text-5xl"><Users className="h-8 w-8 shrink-0 text-[#27a34b] sm:h-11 sm:w-11" strokeWidth={1.8} /> Accountability <span className="text-[#20a34a]">Session</span></h1><p className="mt-1 text-sm text-slate-500">Set one commitment and use a <span className="font-bold underline decoration-[#a98aff] decoration-2 underline-offset-4">guided timer</span> to stay with it.</p></div><img src="/focus-mascot.svg" alt="Calm brain wearing green headphones" className="hidden h-28 w-36 object-contain lg:block" /></header>
