    ...
    <SupportToolLayout>
      ...
      <section className="rounded-xl border border-[#c9ddcd] bg-[#f3faf4] p-4 shadow-sm">
        ...
        <textarea
          id="thought"
          ref={textareaRef}
          className="mt-2 min-h-[120px] w-full resize-none rounded-lg border border-[#c9ddcd] bg-white p-3 text-base leading-6 text-stone-800 placeholder:text-stone-400 focus:border-[#3f7654] focus:outline-none focus:ring-2 focus:ring-[#dbeee0]"
          value={thought}
          onChange={(e) => {
      ...
      {showReframe && analysis ? (
          <section className="space-y-4 rounded-xl border border-[#c9ddcd] bg-white p-4 shadow-sm">
            ...
            <div className="border-t border-stone-200 pt-4">
              ...
              <p className="mt-2 rounded-lg border-l-2 border-[#76a882] bg-[#edf7ef] px-3 py-3 text-sm leading-6 text-stone-800">{analysis.reframe}</p>
            </div>
            <div className="border-t border-stone-200 pt-4">
