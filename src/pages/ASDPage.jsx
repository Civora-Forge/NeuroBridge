import { Brain, BookOpen, Smile, CalendarCheck, MessageCircle, MessagesSquare } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-green-50/40 to-teal-50/40 p-8">
      <div className="max-w-5xl mx-auto text-center mb-12">
        ...
        <p className="text-base text-slate-600 max-w-xl mx-auto">
          Tools for emotional understanding, routine and social confidence.
        </p>
      </div>
