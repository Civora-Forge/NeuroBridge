...
export default function ComingSoon({ title, subtitle, description, color, icon }) {
    return (<div className="animate-fade-in">
      ...
      <div className="flex flex-col items-center justify-center text-center py-16">
        ...
        <div className="neuro-card max-w-lg mx-auto">
          <p className="text-base font-semibold mb-2">Not built yet</p>
          <p className="text-muted-foreground">{description}</p>
          <p className="text-sm text-muted-foreground mt-3">Nothing to set up here — check back later, or use one of your other tools from Home.</p>
        </div>
      </div>
    </div>);
}
