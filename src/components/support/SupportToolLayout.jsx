...
export default function SupportToolLayout({ title, description, progress, status, notice, actions, completion, rating, children }) {
  return (
    <main className="support-tool-page support-tool-layout">
