...
const rawSupportModules = [
  ...
  {
    id: "support.soundscape",
    moduleId: "support.soundscape",
    title: "Soundscapes",
    description: "Use ambient audio layers to support attention or regulation.",
    category: ModuleCategory.SENSORY,
    interventionTypes: ["soundscape", "sensory_regulation"],
    route: "/adhd/sounds",
    tags: ["focus", "noise_sensitivity", "stress", "sleep"],
    disorders: [],
    expectedOutcomeMetrics: ["listening_duration_ms", "layers_active", "rating"],
    developmentDomain: "adhd",
    supportedNeeds: ["attention_support", "sensory_regulation", "stress_reduction"],
    potentiallyRelevantDomains: ["adhd", "asd", "anxiety", "depression", "general"],
    actions: ["start", "stop", "set_volume", "apply_preset", "complete", "abandon"],
    configurableParameters: { layers: true, masterVolume: true, durationMinutes: true },
    launchPolicy: "user_initiated",
    lifecycleEvents: ["shown", "started", "completed", "abandoned", "rated"],
    outcomeFields: ["listening_duration_ms", "layers_active", "rating"],
  ...
  },
  {
    ...
    description: "Collect personal evidence that can challenge negative beliefs.",
    category: ModuleCategory.EMOTIONAL,
    interventionTypes: ["evidence_journal", "thought_support"],
    route: "/depression/proof",
    tags: ["rumination", "low_mood", "cognitive_reframing"],
    disorders: [],
    expectedOutcomeMetrics: ["entries_created", "rating"],
    safetyLevel: SafetyLevel.CAUTION,
    developmentDomain: "depression",
    supportedNeeds: ["cognitive_reframing", "low_mood_support", "emotional_awareness"],
    potentiallyRelevantDomains: ["depression", "anxiety", "general"],
    actions: ["create_entry", "search", "star", "delete", "complete", "abandon"],
    configurableParameters: { category: true, privacy: true },
    launchPolicy: "confirmation_required",
    lifecycleEvents: ["shown", "started", "completed", "abandoned", "rated"],
    outcomeFields: ["entries_created", "rating"],
    legacyIds: [FEATURES.DEPRESSION_PROOF],
  },
];
