...
const rawSupportModules = [
  ...
  },
  {
    ...
    category: ModuleCategory.EXECUTIVE,
    interventionTypes: ["soundscape", "attention_support"],
    route: "/adhd/soundscapes",
    tags: ["focus", "distraction", "stress"],
    disorders: [],
    expectedOutcomeMetrics: ["duration_ms", "layers_active", "rating"],
    developmentDomain: "adhd",
    supportedNeeds: ["attention_support", "stress_reduction"],
    potentiallyRelevantDomains: ["adhd", "anxiety", "general"],
    actions: ["start", "adjust_volume", "stop", "complete", "abandon"],
    configurableParameters: { layers: true, volume: true, timerMinutes: true },
    launchPolicy: "user_initiated",
    lifecycleEvents: ["shown", "started", "progressed", "completed", "abandoned", "rated"],
    outcomeFields: ["duration_ms", "layers_active", "rating"],
    legacyIds: [FEATURES.ADHD_SOUNDS],
  },
  {
